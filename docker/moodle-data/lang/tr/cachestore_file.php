...
/**
 * Strings for component 'cachestore_file', language 'tr', version '5.0'.
 *
...
$string['useserializer'] = 'Serileştiriciyi kullan';
$string['useserializer_help'] = 'Serileştirme için kullanılacak serileştirici. Mevcutsa igbinary serileştirici, büyük önbellekler için depolama gereksinimlerini azaltabilir. Bu yalnızca igbinary uzantısı yüklendiğinde desteklenir.';
