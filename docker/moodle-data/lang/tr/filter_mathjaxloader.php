...
/**
 * Strings for component 'filter_mathjaxloader', language 'tr', version '5.0'.
 *
...
$string['mathjaxsettings_desc'] = 'Varsayılan MathJax yapılandırması çoğu kullanıcı için uygun olmalıdır, ancak MathJax son derece yapılandırılabilir ve standart MathJax yapılandırma seçeneklerinden herhangi biri buraya JSON olarak eklenebilir. Bu alan boş olmalı veya geçerli bir JSON nesnesi içermelidir! Örneğin, AsciiMath ve yakınlaştırma özelliğini etkinleştirmek için bu alanı şu şekilde ayarlayın:
<pre>
{
