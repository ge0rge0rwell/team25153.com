...
/**
 * Strings for component 'badges', language 'tr', version '5.0'.
 *
 * @package     badges
 * @category    string
...
$string['badgeimageinfo'] = 'En iyi sonucu elde etmek için en az 300 x 300 piksel boyutunda kare bir resim yükleyin.';
...
$string['descriptioninfo'] = 'En iyi sonuçları elde etmek için en az 300 x 300 piksel boyutunda kare bir görsel yükleyin.';
...
$string['fixed'] = 'Sabit tarih: bu rozetin süresi aşağıdaki tarihte sona erer:';
$string['hidden'] = 'Gizli';
...
$string['never'] = 'Asla:  bu rozetin süresi dolmaz.';
...
$string['relative'] = 'Göreceli tarih:  bu rozetin süresi bir süre sonra dolmaktadır:';
