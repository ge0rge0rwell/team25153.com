...
/**
 * Strings for component 'search_solr', language 'tr', version '5.0'.
 *
 * @package     search_solr
 * @category    string
...
$string['check_indextoobig'] = 'Belirtilen boyuttan daha büyük dizin';
$string['check_nocore'] = 'Solr sunucusunda dizin bulunamıyor';
$string['check_nosize'] = 'Solr sunucusunda dizin boyutu belirlenemiyor';
$string['check_notconnected'] = 'Solr sunucusuna bağlanılamıyor';
$string['check_time'] = 'Sunucu {$a} durumuyla yanıt verdi.';
...
$string['indexsize'] = 'Dizin boyutu sınırı';
$string['indexsizelimit'] = 'Dizin boyutu sınırı';
$string['indexsizelimit_desc'] = 'Arama dizini bu boyuttan (bayt cinsinden) daha büyük olursa durum raporu sayfasında bir hata gösterir ve %90\'ı aşarsa bir uyarı gösterir. Dizin boyutu sınırı olmaması için sıfıra ayarlayın.';
