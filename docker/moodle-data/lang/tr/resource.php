...
/**
 * Strings for component 'resource', language 'tr', version '5.0'.
 *
 * @package     resource
 * @category    string
...
$string['indicator:cognitivedepth'] = 'Dosya bilişsel';
$string['indicator:cognitivedepth_help'] = 'Bu gösterge, öğrencinin bir Dosya kaynağında ulaştığı bilişsel derinliği esas alır';
$string['indicator:cognitivedepthdef'] = 'Dosya bilişsel';
$string['indicator:cognitivedepthdef_help'] = 'Katılımcı, bu analiz aralığı sırasında Dosya kaynakları tarafından sunulan bilişsel katılımın bu yüzdesine ulaştı (Düzeyler = Görüntüleme yok, Görüntüleme)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Dosya sosyal';
$string['indicator:socialbreadth_help'] = 'Bu gösterge, öğrencinin bir Dosya kaynağında ulaştığı sosyal derinliği esas alır';
$string['indicator:socialbreadthdef'] = 'Dosya sosyal';
$string['indicator:socialbreadthdef_help'] = 'Katılımcı, bu analiz aralığında Dosya kaynakları tarafından sunulan sosyal katılımın bu yüzdesine ulaştı (Düzeyler = Katılım yok, Yalnızca Katılımcı)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['legacyfiles'] = 'Eski kurs dosyalarını taşı';
$string['legacyfilesactive'] = 'Etkin';
$string['legacyfilesdone'] = 'Bitti';
$string['modifieddate'] = 'Değiştirilmiş {$a}';
$string['modulename'] = 'Dosya';
$string['modulename_help'] = 'Dosya modülü, bir öğretmenin kurs kaynağı olarak bir dosya eklemesine yardımcı olur. Mümkün olduğunda, dosya kurs arayüzünde görüntülenir; aksi takdirde öğrencilerden dosyayı indirmeleri istenir. Dosya, destekleyici dosyalar içerebilir, örneğin bir HTML sayfası gömülü görüntülere sahip olabilir.

Dosyayı açmak için öğrencilerin bilgisayarlarında uygun yazılıma sahip olmaları gerektiğini unutmayın.

Bir dosya şu durumlarda kullanılabilir

* Sınıfta verilen sunumları paylaşmak
* Kurs kaynağı olarak mini bir web sitesi eklemek
* Öğrencilerin düzenleyebilmeleri ve değerlendirmeye sunabilmeleri için yazılım programlarının taslak dosyalarını sağlamak';
$string['modulename_link'] = 'mod/resource/view';
$string['modulenameplural'] = 'Dosyalar';
...
$string['popupheight'] = 'Açılır pencere yüksekliği  (piksel cinsinden)';
...
$string['popupwidth'] = 'Açılır pencere genişiği  (piksel cinsinden)';
...
$string['privacy:metadata'] = 'Dosya kaynağı eklentisi herhangi bir kişisel veri saklamaz.';
...
$string['showdate_desc'] = 'Kurs sayfasında yükleme / değiştirilme tarihi görüntülenecek mi?';
...
$string['showsize_desc'] = 'Kurs sayfasında dosya boyutunu gösterilsin mi?';
...
$string['showtype_desc'] = 'Kurs sayfasında dosya türünü (ör. \'Word dokümanı\') görüntüleyelim mi?';
