...
/**
 * Strings for component 'quiz', language 'tr', version '5.0'.
 *
 * @package     quiz
 * @category    string
...
$string['banknotfound'] = 'Soru bankası bulunamadı, lütfen tekrar arayın';
...
$string['configintroglobal'] = 'Bu ayarlar, Quiz etkinliğinin sistem genelindeki davranışını kontrol eder.';
...
$string['currentbank'] = 'Mevcut banka: {$a}';
...
$string['defaultsettings'] = 'Varsayılan sınav ayarları';
...
$string['eventquizattemptgraded'] = 'Sınav denemesi notlandırıldı';
...
$string['groupsnone'] = 'Bu kursta grup yoktur.';
...
$string['overridesnoneforgroups'] = 'Bu sınav için grup geçersiz kılma yoktur.';
...
$string['precreateattempts'] = 'Ön oluşturma denemeleri';
$string['precreateattempts_desc'] = 'Önceden oluşturma denemeleri, site performansını optimize etmeye yardımcı olur. Bu ayarı etkinleştirmenin yanı sıra, önceden oluşturma denemeleri süresini de ayarlamanız gerekir. Not: Bu ayar yalnızca başlangıç saati olan sınavlar için geçerlidir.';
$string['precreateattempts_help'] = 'Önceden deneme oluşturmak, site performansını optimize etmeye yardımcı olur. Bir sınavda deneme yapıldıktan sonra sınav soruları değiştirilemez.';
$string['precreateoff'] = 'Denemeleri önceden oluşturmayın';
$string['precreateperiod'] = 'Önceden oluşturulan deneme süresi';
$string['precreateperiod_desc'] = 'Sitenizde başlangıç saati olan ve birçok öğrencinin aynı anda başladığı sınavlar varsa, denemeleri önceden oluşturarak performansı artırabilirsiniz. Sınav açılmadan önce bir zaman aralığı seçerek denemeleri önceden oluşturun. Sınavın denemeleri başladıktan sonra sınav soruları değiştirilemeyeceğinden, daha kısa bir süre önerilir. Denemeler, varsayılan olarak her saat başı çalışan bir zamanlanmış görev tarafından oluşturulur. Sistem gece gibi sakin olduğunda denemeleri önceden oluşturmak için, süreyi 12 saate ayarlayın ve zamanlanmış görevi daha sakin saatlerde çalışacak şekilde ayarlayın.';
$string['precreatetask'] = 'Önceden oluşturulan denemeler';
$string['precreateusedefault'] = 'Site genelinde varsayılanı kullan ({$a})';
$string['precreateyes'] = 'Evet, sınavın başlamasına {$a} saat kaldı.';
...
$string['quizinvalidquestions'] = 'Bu sınavda geçersiz türde sorular bulunmaktadır. Sınavın kullanılabilmesi için eksik soru türü yeniden yüklenmeli veya etkilenen sorular kaldırılmalıdır.';
...
$string['searchbyname'] = 'İsme göre ara...';
...
$string['selectquestionbank'] = 'Soru bankası seçin';
...
$string['statenotstarted'] = 'Başlamadı';
$string['stateoptions'] = 'Deneme durum seçenekleri';
$string['stateoptions_help'] = '* Başlamadı: Deneme, sınav açılmadan önce otomatik olarak oluşturuldu. Öğrenci henüz denemeye başlamadı.
* Devam ediyor: Öğrenci denemeye başladı. Hala teslim etmek için zamanı var.
* Geç kaldı: Deneme, izin verilen süreden daha uzun süredir açık. Öğrenci, ek süre içinde hala teslim edebilir.
* Teslim edildi: Öğrenci denemeyi tamamladı ve yanıtlarını teslim etti. Otomatik puanlama için sıraya alındı.
* Tamamlandı: Deneme gönderildi ve otomatik puanlama tamamlandı.
* Hiç gönderilmedi: Öğrenci denemeye başladı, ancak süre sınırı veya ek süre içinde göndermedi.';
$string['stateoverdue'] = 'Geciken';
$string['stateoverduedetails'] = '{$a} tarafından teslim edilmelidir';
$string['statesubmitted'] = 'Gönderildi';
$string['status'] = 'Durum';
