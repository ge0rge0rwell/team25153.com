...
/**
 * Strings for component 'tool_usertours', language 'tr', version '5.0'.
 *
...
$string['filter_category_help'] = 'Bu turu, seçilen kategorilerdeki kurslarla ilişkili sayfalarda gösterin.';
$string['filter_course'] = 'Seçilen Kurslar';
$string['filter_course_error_course_selection'] = 'You must select at least one course';
$string['filter_course_help'] = 'Kurslar filtresinin değerine bağlı olarak:

* **Sadece seçilen kurslar**: Bu turu seçilen kurslarla ilişkili sayfalarda gösterin.
* **Seçilenler hariç tüm kurslar**: Bu turu seçili kurslarla ilişkili sayfalarda göstermeyin.';
$string['filter_course_operator'] = 'Kurslar';
$string['filter_course_operator_all'] = 'Kurslar';
$string['filter_course_operator_except'] = 'Seçilenler hariç tüm kurslar';
$string['filter_course_operator_help'] = 'Tur, yalnızca belirli kurslarda görünmek üzere yapılandırılabilir.

* **Tüm kurslar**: Kursdan bağımsız olarak bu turu göster.
* **Yalnızca seçilen kurslar**: Bu turu yalnızca aşağıda seçilen kurslarla ilişkili sayfalarda göster.
* **Seçilenler hariç tüm kurslar**: Bu turu, aşağıda seçilen kurslarla ilişkili sayfalarda gösterme.';
$string['filter_course_operator_select'] = 'Yalnızca seçili kurslar';
...
$string['filter_exclude_category'] = 'Kategorileri hariç tut';
$string['filter_exclude_category_help'] = 'Seçilen kurs kategorileriyle ilişkili sayfalarda bu turu göstermeyin.

Bir üst kategori seçerseniz, ilgili alt kategoriler otomatik olarak seçilecektir ve tek tek seçilemez.

Alt kategorileri tekrar seçmek için üst kategorinin seçimini kaldırın.';
