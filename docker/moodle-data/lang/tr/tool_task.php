...
/**
 * Strings for component 'tool_task', language 'tr', version '5.0'.
 *
 * @package     tool_task
 * @category    string
...
$string['confirmdeletetaskwithid'] = 'ID {$a->id} olan görevi silmek istediğinizden emin misiniz?';
...
$string['deleteadhoctask'] = 'Ad hoc görevi {$a} sil';
...
$string['runclassnamedueonly'] = 'Sadece süresi dolanları çalıştır';
