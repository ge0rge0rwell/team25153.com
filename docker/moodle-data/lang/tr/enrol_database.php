...
/**
 * Strings for component 'enrol_database', language 'tr', version '5.0'.
 *
...
$string['dbsybasequoting_desc'] = 'Sybase tarzı tek tırnak kaçışı - MS SQL ve diğer bazı veritabanları için gereklidir. MySQL için kullanmayın!';
