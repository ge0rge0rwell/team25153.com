...
/**
 * Strings for component 'ai', language 'tr', version '5.0'.
 *
 * @package     ai
 * @category    string
...
$string['action'] = 'Eylem';
$string['action_explain_text'] = 'Metni açıklayın';
$string['action_explain_text_desc'] = 'Bir kurs sayfasındaki metin içeriğini açıklar.';
$string['action_explain_text_instruction'] = 'Kullanıcıdan bir metin girişi alacaksınız. Göreviniz verilen metni açıklamaktır. Bu yönergeleri izleyin:
    1. Detaylandırın: Temel fikir ve kavramları genişletin, açıklamanın anlamlı bir derinlik katmasını sağlayın ve metni kelimesi kelimesine tekrarlamaktan kaçının.
    2. Basitleştirin: Karmaşık terimleri veya fikirleri daha basit bileşenlere ayırarak öğrenciler de dahil olmak üzere geniş bir kitle için anlaşılmasını kolaylaştırın.
    3. Bağlam Sağlayın: Bir şeyin neden olduğunu, nasıl çalıştığını veya amacının ne olduğunu açıklayın. Uygun olan yerlerde anlayışı geliştirmek için ilgili örnekler veya benzetmeler ekleyin.
    4. Mantıksal olarak düzenleyin: Açıklamanızı doğal bir şekilde akacak şekilde yapılandırın, daha ince ayrıntılara geçmeden önce temel fikirlerle başlayın.

Önemli Talimatlar:
    1. Özeti yalnızca düz metin olarak gönderin.
    2. Herhangi bir markdown biçimlendirmesi, selamlama veya basmakalıp ifadeler eklemeyin.
    3. Açıklık, kısalık ve erişilebilirliğe odaklanın.

Açıklamanın okunmasının kolay olduğundan ve orijinal metnin ana noktalarını etkili bir şekilde aktardığından emin olun.';
...
$string['actionsettings'] = 'Eylem ayarları';
$string['actionsettings_desc'] = 'Bu ayarlar, bu sağlayıcı örneği için AI eylemlerini kontrol eder.';
$string['ai'] = 'Yapay Zeka';
$string['aiactionregister'] = 'YZ eylem kaydı';
$string['aiplacements'] = 'Yapay zeka uygulamaları';
$string['aipolicyacceptance'] = 'Yapay zeka politikasının kabulü';
$string['aipolicyregister'] = 'Yapay zeka politika kaydı';
$string['aiproviders'] = 'Yapay Zeka sağlayıcıları';
$string['aireports'] = 'Yapay zeka raporları';
$string['aiusage'] = 'YZ kullanımı';
...
$string['btninstancecreate'] = 'Örnek oluştur';
$string['btninstanceupdate'] = 'Güncelleme örneği';
$string['completiontokens'] = 'Tamamlama belirteçleri';
$string['contentwatermark'] = 'YZ tarafından üretilmiştir';
$string['dateaccepted'] = 'Tarih kabul edildi';
...
$string['privacy:metadata:ai_action_register:model'] = 'Cevabı oluşturmak için kullanılan model.';
...
$string['providermoveddown'] = '{$a} aşağı taşındı.';
$string['providermovedup'] = '{$a} yukarı taşındı.';
