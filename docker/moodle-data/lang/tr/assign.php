...
/**
 * Strings for component 'assign', language 'tr', version '5.0'.
 *
 * @package     assign
 * @category    string
...
$string['assignmentduedigestsms'] = 'Bir veya daha fazla ödev 7 gün içinde teslim edilmelidir. Yaklaşan ödevleri görmek için oturum açın.';
...
$string['assignmentduesoonofflinehtml'] = '<p>Merhaba {$a->firstname},</p>
<p>{$a->coursename} kursundaki <strong>{$a->assignmentname}</strong> ödevinin son teslim tarihi <strong>{$a->duedate}</strong> idi.</p>
<p>Ödevinizi hâlâ gönderebilirsiniz ancak gönderiminiz gecikmiş olarak işaretlenecektir.</p>
<p><a href="{$a->url}">Etkinliğe git</a></p>';
$string['assignmentduesoonsms'] = 'Ödeviniz {$a->ödevadı} {$a->ödev tarihi} tarihinde teslim edilecektir: {$a->url}';
...
     {$a->url}';
$string['assignmentmailhtml'] = '<p>{$a->grader}, \'{$a->assignment}\' gönderdiğiniz ödev için  bazı geri bildirimler gönderdi.</p>
<p> <a href="{$a->url}">ödev gönderiminize</a> eklendiğini görebilirsiniz.</p>';
...
$string['assignmentoverduesms'] = 'Ödeviniz {$a->ödevadı} {$a->gecikme tarihi} tarihinde gecikmiştir: {$a->url}';
...
$string['feedbackavailableanonhtml'] = '\'{$a->assignment}\' için ödev gönderiminizle ilgili yeni geri bildiriminiz var. <a href="{$a->url}">ödev gönderiminize</a> eklendiğini görebilirsiniz.';
$string['feedbackavailableanonsmall'] = '{$a->assignment} ödevi için yeni geri bildirim';
$string['feedbackavailableanonsms'] = '\'{$a->coursefullname}\' içindeki \'{$a->assignment}\' hakkında yeni geri bildirim. Görüntülemek için giriş yapın';
...
Ödev tesliminize eklendiğini görebilirsiniz:
    ...
    {$a->url}';
$string['feedbackavailablehtml'] = '$a->kullanıcıadı}, \'{$a->ödev}\' için yaptığınız ödev gönderimi hakkında geri bildirim gönderdi.
Bunu <a href="{$a->url}">ödev gönderiminize</a> eklenmiş olarak görebilirsiniz.';
$string['feedbackavailablesmall'] = '{$a->username}, {$a->assignment} ödevi için geri bildirim verdi';
$string['feedbackavailablesms'] = '\'{$a->coursefullname}\' içindeki \'{$a->assignment}\' hakkında yeni geri bildirim. Görüntülemek için oturum açın';
...
$string['filtergraded'] = 'Değerlendirildi';
...
$string['gradepenalty'] = 'Not';
$string['gradepenalty_help'] = 'Etkinleştirilirse, son teslim tarihinden sonra gönderilen ödevlere ceza uygulanacaktır.';
$string['gradersubmissionupdatedhtml'] = '{$a->kullanıcı adı} \'{$a->ödev}\' için ödev gönderimini {$a->güncelleme zamanı}\'nda güncelledi. <a href="{$a->url}">ödev gönderimleri</a> içinde mevcuttur.';
$string['gradersubmissionupdatedsmall'] = '{$a->username} Ödev gönderimleri güncellendi{$a->assignment}.';
$string['gradersubmissionupdatedsms'] = '{$a->username}, \'{$a->coursefullname}\' kursundaki \'{$a->assignment}\' ödevini güncelledi. Görüntülemek için oturum açın.';
...
$string['groupsnone'] = 'Bu kursta grup yok.';
...
$string['overriderecalculatepenalty'] = 'Geçersiz kılınan kullanıcı(lar) için cezayı yeniden hesapla';
...
$string['penaltyduedatechangemessage'] = 'Bazı notlar çoktan verilmiştir. Son tarihi değiştirmek, cezayı devre dışı bırakmak/etkinleştirmek için öncelikle mevcut notların yeniden hesaplanıp hesaplanmayacağını seçmeniz gerekir.';
...
$string['submissioncontains'] = 'Gönderinizin içeriği:';
$string['submissioncopiedhtml'] = '<p>\'{$a->assignment}\' için önceki ödev gönderiminizin bir kopyasını oluşturdunuz.</p>
<p> <a href="{$a->url}">ödev gönderiminizin</a> durumunu buradan görebilirsiniz.</p>';
$string['submissioncopiedsmall'] = '{$a->assignment} için önceki ödev gönderimini kopyaladınız.';
$string['submissioncopiedsms'] = '\'{$a->assignment}\' için \'{$a->coursefullname}\' adresinde önceki gönderiminizin bir kopyasını oluşturdunuz. Görüntülemek için oturum açın.';
$string['submissioncopiedtext'] = '\'{$a->assignment}\' gönderdiğiniz ödevin kopyasını oluşturdunuz

Ödev gönderiminizin durumunu şuradan görebilirsiniz:
...
$string['submissionreceiptcontains'] = 'Gönderilen içerik ({$a->total} öge):';
$string['submissionreceipthtml'] = '<p> \'<i>{$a->assignment}</i>\' ödevini gönderdiniz. </p>
<p> <a href="{$a->url}">ödev gönderiminizin</a> durumunu buradan görebilirsiniz.</p>
{$a->submissionsummaryhtml}';
$string['submissionreceiptotherhtml'] = '\'{$a->assignment}\' i ödeviniz gönderildi. <a href="{$a->url}">ödev gönderiminizin</a> durumunu buradan görebilirsiniz.';
$string['submissionreceiptothersmall'] = '{$a->assignment} için ödev gönderiminiz gönderildi.';
$string['submissionreceiptothersms'] = '\'{$a->assignment}\' için \'{$a->coursefullname}\' adresine gönderim yapıldı. Gönderim durumunuzu görüntülemek için oturum açın.';
$string['submissionreceiptothertext'] = '\'{$a->assignment}\'  ödeviniz gönderildi.

Ödev gönderiminizin durumunu şuradan görebilirsiniz:

    {$a->url}';
$string['submissionreceipts'] = 'Gönderi alındılarını gönder.';
$string['submissionreceiptsmall'] = 'Ödev gönderme onayı - {$a->assignment}';
$string['submissionreceiptsms'] = '{$a->assignment}\' adlı ödevi, \'{$a->coursefullname}\' adlı kursa teslim ettiniz. Teslimat durumunu görmek için giriş yapın.';
...
$string['usersnone'] = 'Bu kursa kayıtlı kullanıcı yok.';
