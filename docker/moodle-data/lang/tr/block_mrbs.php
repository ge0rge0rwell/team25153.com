...
/**
 * Strings for component 'block_mrbs', language 'tr', version '5.0'.
 *
 * @package     block_mrbs
 * @category    string
...
$string['config_times_right_side2'] = 'Gün ve hafta görünümünde saatleri sağ tarafta görüntülemek için Evet olarak ayarlayın';
...
$string['createdby'] = 'Oluşturan kişi';
$string['cronfile'] = 'Oturum içe aktarma dosyasının konumu';
...
$string['hours'] = 'saat';
$string['importedbookingmoved'] = 'İçe Aktarılan Rezervasyon (Düzenlendi)';
$string['in'] = 'da';
$string['include'] = 'Kapsam';
$string['internal'] = 'İç';
$string['invalid_booking'] = 'Geçersiz Revervasyon';
...
$string['mrbs'] = 'Toplantı Odası Rezervasyon Sistemi';
$string['mrbs:editmrbs'] = '';
...
$string['no_users_initial'] = 'Veri tabanında kullanıcı tanımlı değil, ilk kullanıcı oluşturmaya izin ver';
...
$string['startedimport'] = 'Dosya bulundu, içe aktarma işlemi başlatılıyor...';
