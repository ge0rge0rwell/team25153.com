...
$string['hidecategorymany'] = '{$a->category} kategorisi {$a->coursecount} kurs içermektedir.
<br/>Bunu gizlerseniz, gizli kategorileri görüntüleme izni olmayan kullanıcılar artık kurslara erişemeyeceklerdir.';
$string['hidecategoryone'] = '{$a->category} kategorisi 1 kurs içerir.
<br/>Bunu gizlerseniz, gizli kategorileri görüntüleme izni olmayan kullanıcılar artık kursa erişemeyeceklerdir.';
...
$string['modhidden'] = 'Kullanılabilirlik';
$string['modhidden_help'] = '* Kurs sayfasında gizle: Öğrenciler için kullanılamaz. Bu modül öğrencilere gösterilemez.';
...
$string['showpopovermenu'] = 'Açılır pencere';
