...
/**
 * Strings for component 'grades', language 'tr', version '5.0'.
 *
 * @package     grades
 * @category    string
...
$string['csv'] = 'CSV';
$string['currentgrade'] = 'Geçerli not';
...
$string['errornegativepenalty'] = '{$a} not kimliği için ceza puanı toplamından negatif değer alındı." (Veya daha sade:) "{$a} not kimliği için ceza toplamından negatif değer alındı.';
...
$string['gradepenalty'] = 'Not ceazaları';
$string['gradepenalty_enabledmodules'] = 'Etkinlikleri etkinleştir';
$string['gradepenalty_enabledmodules_help'] = 'Seçilen etkinlikler için not cezalarını etkinleştirin.';
$string['gradepenalty_indicator_info'] = 'Uygulanan gecikme cezası -{$a} puanları';
$string['gradepenalty_supportedplugins'] = 'Desteklenen etkinkileri yönetin';
...
$string['managepenaltyplugins'] = 'Ceza eklentilerini yönet';
...
$string['modgraderecalculatepenalty'] = 'Cezayı yeniden hesapla';
$string['modgraderecalculatepenalty_help'] = 'Ceza tüm kullanıcılar için yeniden hesaplanacaktır.';
...
$string['originalgrade'] = 'Orijinal not';
...
$string['recalculatepenalty'] = 'Cezaları yeniden hesaplayın';
$string['recalculatepenaltyconfirm'] = 'Bu, bu kapsamdaki tüm gönderimler için cezaları yeniden hesaplayacak ve uygulayacaktır. Devam etmek istediğinizden emin misiniz?';
$string['recalculatepenaltysuccess'] = 'Ceza yeniden hesaplanıyor. Notların güncellenmesi biraz gecikebilir.';
$string['recalculatinggrades'] = 'Notları tekrar hesapla';
$string['recalculatinggradesadhoc'] = 'Rapor otomatik olarak güncellenecektir. Hiçbir şey yapmanıza gerek yoktur.';
