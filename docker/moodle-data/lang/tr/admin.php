...
/**
 * Strings for component 'admin', language 'tr', version '5.0'.
 *
 * @package     admin
 * @category    string
...
$string['clistatusenabledlater'] = 'Durum: {$a} üzerinde Komut Satırı Arayüzü (CLI) bakım modu etkinleştirilecektir.';
$string['clitypevalue'] = '';
...
$string['cliupgradesetlock'] = 'Yükseltme işlemi yalnızca Komut Satırı Arayüzü (CLI) üzerinden gerçekleştirilebilecek şekilde kilitlenmiştir.';
$string['cliupgradeunsetlock'] = 'Mevcut Komut Satırı Arayüzü (CLI) yürütme yükseltme kilidi kaldırıldı.';
...
$string['configdebugdisplay'] = 'Eğer etkinleştirilirse, hata ayıklama (debug) mesajları HTML sayfasında görüntülenir; bu durum XHTML, JavaScript, çerezler (cookies) ve genel olarak HTTP üstbilgilerinin (headers) yapısını bozar. Aksi takdirde, hata ayıklama mesajları sunucu günlüklerinde (logs) saklanarak daha iyi bir hata ayıklama süreci sağlar. Hangi günlüğün kullanılacağını ise error_log adlı PHP ayarı kontrol eder.';
...
$string['configmailnewline'] = 'Giden e-postalar için satır sonu biçimini ayarlar. Evrensel e-posta standardı RFC 822bis, Satır Başı ve Satır Besleme (CRLF) gerektirse de posta sunucularının bu karakterleri işleme biçimleri farklılık gösterir. Bazı sunucular yalın Satır Besleme (LF) sonlarını otomatik olarak düzeltirken, diğerleri hatalı biçimde çift aralıklı satırlar (CRCRLF) oluşturur veya yalnızca LF içeren e-postaları reddeder. Teslim edilemeyen e-postalar veya çift yeni satır sorunları yaşıyorsanız bu ayarı değiştirin.';
...
$string['configpathtophp'] = 'PHP Komut Satırı Arayüzü (CLI) yolu. Genellikle /usr/bin/php veya benzeridir. Bu yolu girerseniz, cron komut dosyaları yönetici web arayüzünden çalıştırılabilir.';
...
$string['configsmtphosts'] = 'Moodle\'ın e-posta göndermek için kullanması gereken bir veya daha fazla yerel SMTP sunucusunun tam adını girin (örn. \'mail.a.com\' veya \'mail.a.com;mail.b.com\'). Varsayılan dışındaki bir portu (örneğin 25 numaralı port haricinde) belirtmek için [sunucu]:[port] söz dizimini kullanın (örn. \'mail.a.com:587\'). Güvenli bağlantılar için genellikle SSL ile 465 numaralı port, Aktarım Katmanı Güvenliği (TLS) ile ise 587 numaralı port kullanılır. Gerekiyorsa güvenlik protokolünü aşağıda belirtin. Bu alanı boş bırakırsanız Moodle, e-posta göndermek için PHP\'nin varsayılan yöntemini kullanacaktır.';
...
$string['configsmtpoauthservice'] = 'SMTP sunucusuyla iletişim kuracak şekilde yapılandırılmış OAuth 2 hizmetini seçin. İlgili hizmet henüz mevcut değilse yeni bir tane oluşturmanız gerekir. SMTP kimlik doğrulama türünü XOAUTH2 olarak ayarlamanız gerektiğini unutmayın.';
...
$string['configyuicomboloading'] = 'Bu seçenek, YUI kütüphaneleri için birleştirilmiş dosya yükleme optimizasyonunu etkinleştirir. Performans nedenleriyle etkinleştirilmelidir.';
...
$string['deletedplugintypesdetected'] = '\'{$a}\' adında silinmiş bir eklenti tespit edildi. Bu eklentinin kullanımdan kaldırma penceresi sırasında taşınmış/kaldırılmış olması gerekirdi. Bu artık desteklenmeyen bir eklenti türüdür ve bu eklenti kaldırılana kadar kurulum/yükseltme devam edemez.';
...
$string['geoipfile'] = 'GeoIP Şehir Veritabanı';
...
$string['maxtimelimit_desc'] = 'Moodle\'ın izin vereceği maksimum PHP çalışma süresini sınırlamak için herhangi bir çıktı gösterilmeden burada saniye cinsinden bir değer girin. 0, Moodle\'ın varsayılan kısıtlamalarının kullanıldığı anlamına gelir. Kendi zaman sınırı olan bir ön uç sunucunuz varsa, bu değeri loglarda PHP hataları almak için daha düşük ayarlayın. Komut Satırı Arayüzü (CLI) betikleri için geçerli değildir.';
...
$string['navfilter'] = 'Özel menüyü filtrele';
$string['navfilter_desc'] = 'Özel menüyü <strong>İçerik ve Başlıklara</strong> uygulanacak şekilde ayarlanmış Moodle filtreleri aracılığıyla işleyin. Dinamik özel menü ögelerini etkinleştirmek için kullanışlıdır.';
...
$string['purgecoursecache'] = 'Kurslar';
...
$string['showuseridentity_desc'] = 'Kullanıcı seçerken veya ararken ve kullanıcı listelerini görüntülerken, bu alanlar tam adlara ek olarak gösterilebilir. Alanlar yalnızca moodle/site:viewuseridentity özelliğine sahip kullanıcılara gösterilir; varsayılan olarak öğretmenler ve yöneticiler. Bu ayar, kurumunuzda zorunlu olan bir veya iki alanı seçmeniz durumunda en mantıklısıdır.

* ile işaretlenmiş alanlar, özel kullanıcı profili alanlarıdır (metin türünde ve 255 karakter sınırlı). Bu alanlar şu anda tüm ekranlarda gösterilmemektedir.';
...
$string['sitemaintenanceoncli'] = 'Siteniz şu anda Komut Satırı Arayüzü (CLI) bakım modunda. Web erişimine izin verilmiyor.';
