...
/**
 * Strings for component 'error', language 'tr', version '5.0'.
 *
 * @package     error
 * @category    string
...
$string['invaliddatetimebetween'] = '{$a->after} öğesi {$a->before} öğesinden önce olmalıdır.';
$string['invaliddatetimemode'] = 'Zaman değiştirilmiş filtre için geçersiz mod: {$a}';
