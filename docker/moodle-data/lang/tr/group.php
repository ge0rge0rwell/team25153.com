...
/**
 * Strings for component 'group', language 'tr', version '5.0'.
 *
 * @package     group
 * @category    string
...
$string['deleteallgroupings'] = 'Tüm gruplamalar';
$string['deleteallgroups'] = 'Tüm gruplar';
...
$string['deleteselectedgroup'] = 'Sil';
$string['disablemessagingaction'] = 'Mesajlaşmayı devre dışı bırak';
...
$string['enablemessaging'] = 'Grup mesajlaşması';
$string['enablemessaging_help'] = 'Etkinleştirilirse, grup üyeleri, mesajlaşma işlemcisi aracılığıyla gruplarındaki diğer kişilere mesaj gönderebilir.';
$string['enablemessagingaction'] = 'Mesajlaşmayı etkinleştir';
...
Not: Kendi kayıt ayarlarında grup kayıt tuşları etkinleştirilmelidir ve kurs için bir kayıt anahtarı belirtilmelidir.';
...
$string['erroraddtogroup'] = 'addtogroup için geçersiz değer. Grup modu olmaması için 0 veya yeni bir grup oluşturulması için 1 olmalıdır.';
$string['erroraddtogroupgroupname'] = 'addtogroup ayarlandığında grup adı belirtemezsiniz.';
...
$string['exportgroupsgroupings'] = 'Grupları ve gruplamaları şu şekilde indirin:';
...
$string['grouping_help'] = 'Bir gruplama, bir kurs içindeki grupların bir toplamıdır. Bir gruplandırma seçilirse, grup içindeki gruplara atanan öğrenciler birlikte çalışabilecektir.';
...
$string['groupingsection_help'] = 'Bir gruplama, bir kurs içindeki grupların bir toplamıdır. Burada bir gruplandırma seçilirse, yalnızca bu grup içerisindeki gruplara atanan öğrenciler bu bölüme erişebilir.';
...
$string['groupmode_groupsseparate_help'] = 'Öğrenciler gruplara ayrılır ve sadece kendi gruplarının çalışmalarını görebilirler.';
$string['groupmode_groupsvisible_help'] = 'Öğrenciler gruplara ayrılır, ancak diğer grupların çalışmalarını görebilirler.';
$string['groupmode_help'] = '* Grup yok
* Ayrı gruplar: Öğrenciler gruplara ayrılır ve sadece kendi gruplarının çalışmalarını görebilirler.
* Görünür gruplar: Öğrenciler gruplara ayrılır ancak diğer grupların çalışmalarını görebilirler.

Kurs düzeyinde ayarlanan grup modu, tüm etkinlikler için varsayılan moddur. Grup modu kurs düzeyinde zorunlu kılınmışsa bir etkinlikte değiştirilemez.';
$string['groupmodeforce'] = 'Grup modu zorunluluğu';
$string['groupmodeforce_help'] = 'Grup modu tüm etkinlikler için zorunludur ve bir etkinlikte değiştirilemez.';
...
$string['groupsgroupings'] = 'Grup ve gruplamalar';
...
* Dosyanın her satırı tek bir kayıt içermeli
* Her kayıt, virgülle ayrılmış bir dizi veri olmalı
* İlk kayıt, dosyanın geri kalanının formatını tanımlayan alan adlarının bir listesini içermeli
* Gerekli alan adı grup ismi olmalı
*  İsteğe bağlı alan adları şunlardır: groupidnumber, description, enrolmentkey, groupingname, enablemessaging';
...
$string['manageactions'] = 'Yönetim';
$string['memberofgroup'] = 'Grup üyesi: {$a}';
$string['members'] = 'Her gruptaki üye';
$string['membersofselectedgroup'] = 'Üyelerin ait olduğu grup:';
$string['messagingdisabled'] = 'Mesajlaşma {$a} grubunda/gruplarında başarıyla devre dışı bırakıldı';
$string['messagingenabled'] = 'Mesajlaşma {$a} grubunda/gruplarında başarıyla etkinleştirildi.';
...
$string['nonparticipation'] = 'Katılımcı olmayan';
...
$string['participation'] = 'Grup modundaki etkinlikler için açılır menüde grubu göster';
$string['participation_help'] = 'Grup üyeleri ayrı veya görünür gruplar modundaki etkinlikler için bu grubu seçebilmeli mi? (Yalnızca grup üyeliği görünürse veya yalnızca üyeler tarafından görülebiliyorsa geçerlidir).';
$string['participationshort'] = 'Katılım';
$string['potentialmembers'] = 'Olası üyeler: {$a}';
$string['potentialmembs'] = 'Olası üyeler';
$string['printerfriendly'] = 'Yazıcı-dostu görünüm';
$string['privacy:metadata:core_message'] = 'Grup konuşmaları';
$string['privacy:metadata:groups'] = 'Grup üyeliği kaydı.';
$string['privacy:metadata:groups:groupid'] = 'Grubun kimliği.';
$string['privacy:metadata:groups:timeadded'] = 'Kullanıcının gruba ne zaman eklendiğini gösteren zaman damgası.';
$string['privacy:metadata:groups:userid'] = 'Grupla ilişkili kullanıcının kimliği.';
...
$string['removegroupingsmembers'] = 'Tüm grup gruplamaları';
$string['removegroupsmembers'] = 'Tüm grup üyeleri';
...
$string['visibility'] = 'Grup görünürlüğü';
$string['visibility_help'] = '* Görünür - tüm kurs katılımcıları grupta kimlerin olduğunu görebilir
* Sadece üyeler tarafından görülebilir - grupta yer almayan kurs katılımcıları grubu veya üyelerini görüntüleyemez
* Sadece kendi üyeliğini gör - bir kullanıcı grupta olduğunu görebilir ancak diğer grup üyelerini göremez
* Gizli - grubu ve üyelerini yalnızca öğretmenler görüntüleyebilir

Gizli grupları görüntüleme özelliğine sahip kullanıcılar grup üyeliğini her zaman görüntüleyebilir.

Grubun üyeleri varsa bu ayarı değiştiremeyeceğinizi unutmayın.';
$string['visibilityall'] = 'Görülebilir';
$string['visibilitymembers'] = 'Üyeler tarafından görülebilir';
$string['visibilitynone'] = 'Gizli';
$string['visibilityown'] = 'Sadece Kendi üyeliğinizi görün';
$string['visibilityshort'] = 'Görünür';
$string['withselected'] = 'Seçilenlerle';
