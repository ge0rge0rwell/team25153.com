...
/**
 * Strings for component 'gradingform_btec', language 'tr', version '5.0'.
 *
...
$string['name'] = 'Adı';
$string['no'] = 'hayır';
$string['previewbtecmarking'] = 'BTEC değerlendirmesini önizleme';
...
$string['save'] = 'Kaydet';
$string['savebtecdraft'] = 'Taslak olarak kaydet';
$string['yes'] = 'evet';
