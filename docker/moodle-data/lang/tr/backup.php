...
/**
 * Strings for component 'backup', language 'tr', version '5.0'.
 *
 * @package     backup
 * @category    string
...
$string['qcategory2coursefallback'] = 'Yedekleme dosyasında orijinal olarak system|course|course_category bağlamında bulunan "{$a->name}" soru kategorisi, geri yükleme ile bir soru bankası modülü bağlamında oluşturulacaktır';
$string['qcategorycannotberestored'] = '"{$a->name}" sorusu kategorisi, geri yükleme tarafından oluşturulamaz';
$string['question2coursefallback'] = 'Yedekleme dosyasında orijinal olarak system|course|course_category konumunda bulunan "{$a->name}" soru kategorisi, geri yükleme ile bir soru bankası modülü bağlamında oluşturulacaktır';
