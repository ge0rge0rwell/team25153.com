...
class __Mustache_db9aa211bf6e36834e52b6a99d149958 extends \Mustache\Template
{
...
';
        ...
        $value = $this->resolveValue($context->findDot('count.total', true), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '</span>)
';
...
';
        $buffer .= $indent . '                class="';
        $value = $context->findDot('count.unread', true);
        if (empty($value)) {
...
';
        ...
        $value = $this->resolveValue($context->findDot('count.unread', true), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '</span>
';
        $buffer .= $indent . '                <span class="visually-hidden" id="';
...
';
        ...
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_lazy_load_list')) {
            $context->pushBlockContext([
                'rootclasses' => [$this, 'blockDdc0cfe2ccf734ee20370637cfbb62ea'],
                'rootattributes' => [$this, 'block7c059640b0d48d1f94e63f4a8a752c79'],
            ]);
...
';
    ...
    private function sectionD8b2b5e9cb2ad16c466ba9dd3cf4a9ca(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section157ed066b52ac7131926b0c2638ed003(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section2583a6656b06f3645e457db265540388(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
