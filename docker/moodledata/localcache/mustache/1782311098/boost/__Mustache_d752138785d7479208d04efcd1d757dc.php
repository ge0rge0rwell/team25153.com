...
class __Mustache_d752138785d7479208d04efcd1d757dc extends \Mustache\Template
{
...
';
    ...
    private function section7c04418fb1ac10c2f8bbc38e19a7e6f3(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section64bd7db84b8533b07dee79cd437a0887(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionD01943ab4af9e11b8162452fa104dec4(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section4fff29ce050a3086d17820b3f0d560b4(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
