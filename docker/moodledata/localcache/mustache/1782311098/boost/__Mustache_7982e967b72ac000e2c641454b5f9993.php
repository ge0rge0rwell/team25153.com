...
class __Mustache_7982e967b72ac000e2c641454b5f9993 extends \Mustache\Template
{
...
';
        $buffer .= $indent . '        <div class="drawerheading">
';
        $buffer .= $indent . '            ';
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="draweractions">
';
        $buffer .= $indent . '            <div class="drawerheadercontent">
';
        $buffer .= $indent . '                ';
...
';
        $buffer .= $indent . '                class="btn btn-icon icon-size-3 drawertoggle"
';
...
';
        $buffer .= $indent . '            >
';
        $blockFunction = $context->findInBlock('closebuttonicon');
        if (is_callable($blockFunction)) {
            $buffer .= call_user_func($blockFunction, $context);
        } else {
            $buffer .= $indent . '                    ';
...
';
    ...
    private function section36783d1fe3b25f68270791f3280502a0(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section3ceccb3c2cc6577d11393fddf80762a9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
