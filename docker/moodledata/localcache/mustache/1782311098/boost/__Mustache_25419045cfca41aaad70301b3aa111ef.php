...
class __Mustache_25419045cfca41aaad70301b3aa111ef extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section363ee2fc9281772cb702b13a25185690($context, $indent, $value);
        $value = $context->find('displaygroupingselector');
        if (empty($value)) {
...
';
    ...
    private function sectionCdca03c966985271d933771f38d17201(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionF8249148f760da3e109caa3663f633ad(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionDd89a06415c3a9738588538d22ed5719(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section7aa86992f913c684aa982299bc5b0237(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section3842a12aa13716271b547dd2b63a83f0(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section943672e65d749500a0e39a5c5732165b(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section423ab0cbddfc75d44c8e8c6d7354a909(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section73e2d31fbcff71568286bba0816b9728(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA95d1da52da1e6b0fb8c273a6af61e45(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section1e8dea46004e4fe5964bd9187fa70241(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionC723f5724128554b7185f98be27ffdca(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section6a8fa4f1d83488a4bff00ad9c6b4e87c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section33d18a9baa544480c9874cbbfef7bfd0(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section62c24258cc369df41565ccf8e4d02cf8(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section351479d60e926483df14f8612bc07800(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section2baefc80a6c574d8f63074ae198cd792(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA8d7f2948d337ed8382ec87fd9040693(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionBfccddfcef129c993aebf4ea499b00f4(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionD4e51cc446cca6db12110f7d2dd6dc30(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6a2e4a8597805bb70bcf8a5cd54793e1(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionFffd4a6c3b34db8d4d5b5de5a54652a3(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section8035b57ae92326df403c45b19619cf49(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section7222f7e2a44170ca5df3f701b371a5f2(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section60cb1bc6b8bef86f0ebcc4100b812ad9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB302a1e85c352759ac46ea1e16cf22df(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEf3b21f97bc8fe4506d69d5331b9f4b9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section27318474f4eb38fa1db0ebfdc96688e8(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section68a63c73f4736b6ecd346553e078ef61(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section153539089d04b17ab672bafd0b927502(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA6b4de8817268f50849413abb85ceafc(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA0d6bc2dd5f49bbd3f2040aaf69a67b9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section356026611c829ff09fb2897482093eff(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section363ee2fc9281772cb702b13a25185690(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
