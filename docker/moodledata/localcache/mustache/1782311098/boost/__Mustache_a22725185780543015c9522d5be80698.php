...
class __Mustache_a22725185780543015c9522d5be80698 extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext([
                'classes' => [$this, 'block4100c75ced44c533f753c4400abe0aa9'],
                'attributes' => [$this, 'block4d7b943ed8bdd2f896f38565eeba9834'],
                'togglelabel' => [$this, 'block49755b0d0263ce26b21c3272d20a3455'],
                'togglecontent' => [$this, 'blockC92e9b614050378508963e271348d6f9'],
                'containerrole' => [$this, 'blockAd56411833f7d117f5cf7e7217f0c3d4'],
                'containerattributes' => [$this, 'block28f0348cd101168be4bf35e2e1a9e09f'],
                'containerlabel' => [$this, 'blockF6d8c93b345b7eb17ebfdd116a81a5d9'],
                'headertext' => [$this, 'block2dccea8523966aa03bc51b5c4aafc01b'],
                'headeractions' => [$this, 'block2da5b1c7179a776050de757a455b8c83'],
                'content' => [$this, 'block8574f609b05883305ebdf85b73a43a8c'],
            ]);
    ...
    private function sectionE9d311101fe112f08c4725ee17f65ad1(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section83c1c45b4b741aef24006ff87a6e04ce(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section8f0bc69b9ec68496ec93567882082edc(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section6b060811f5077480962b875ea13a66be(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionEb70af33b8011de7432c8334305b6a62(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section0485fa7464a648704afa92570f0944b7(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionD52891bef9837f9da27028964220b7a5(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section256b33e22ff1d9e74ef049e25110e90a(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section5c109cc11ee011897152888aaf4973ba(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section7680c9ab48e1615ec8d80b97eeaa59cd(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionDee494eca726473d1b3efc8f73edb3ea(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7a20f6a0c1e5f01649c33230170638b5(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section994b8f5d6e68f8b801322b51753a03c8(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section7fd8a95ce9a614b8c5bab7e83009f0ca(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section6878b033f78f4ceb02dea4ab217fda11(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block2da5b1c7179a776050de757a455b8c83($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '        </a>
';
        $value = $context->findDot('urls.preferences', true);
