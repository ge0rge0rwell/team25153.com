...
class __Mustache_9f9c12978e52fe56044a084f2159aebe extends \Mustache\Template
{
...
';
    ...
    private function sectionB69af701c3da068c4b63a9d598702913(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section03e5aa7999199f1d3189e45026af95da(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionFa23ba6f88204e1ae20c4d35663caf0c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionE10894e1d199b8d98cd9097196b8b1a7(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
