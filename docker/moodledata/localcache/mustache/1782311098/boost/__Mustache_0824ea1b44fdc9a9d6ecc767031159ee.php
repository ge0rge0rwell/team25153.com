...
class __Mustache_0824ea1b44fdc9a9d6ecc767031159ee extends \Mustache\Template
{
...
';
        $buffer .= $indent . '    <button class="btn btn-icon"
';
...
';
        $buffer .= $indent . '        <i class="icon fa fa-angles-down fa-fw m-0" aria-hidden="true"></i>
';
        $buffer .= $indent . '    </button>
';
        $buffer .= $indent . '    <div class="dropdown-menu dropdown-menu-end" role="menu" id="courseindexdrawercontrolsmenu" aria-labelledby="courseindexdrawercontrolsmenubutton">
';
...
';
    ...
    private function section72de7bd71769771a8c5b8a91517a7a84(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionC956bd408046825a22f12d78fd34eb0b(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section8c98a143aad766c17f80893930467784(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB4c4513ed48dca32a697c66f27aba45d(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionE33c0bb533527d1ee3483f1398bc6ede(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
