...
class __Mustache_e9f11d699dc710fca1644b2b08aa1252 extends \Mustache\Template
{
...
';
        ...
        $buffer .= $indent . '
';
        $value = $context->findDot('output.page_heading_menu', true);
...
';
        $value = $context->findDot('output.search_box', true);
        ...
        $buffer .= $indent . '            ';
        $value = $this->resolveValue($context->findDot('output.edit_switch', true), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $value = $context->findDot('output.navbar_plugin_output', true);
        $buffer .= $this->section230168602eb7e298ac221fa06d825999($context, $indent, $value);
        $value = $context->find('usermenu');
        $buffer .= $this->section589806545bc41bb140a3a502e186158f($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section1880a930791c830b67e23ff34b5a4123(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB88b20c96dd523877b35fd7e4389a3fd(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section461071542e460fd411dfc650298f20d9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section07e819b1f3f35b4c60bd7e2c826e6088(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionF1fd492313ef64942639bd2a69db2fa4(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                ';
                $value = $this->resolveValue($context->findDot('output.page_heading_menu', true), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
                $buffer .= $indent . '            </ul>
';
    ...
    private function section8759d71b90e6496204ea4d094c43fb8c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                ';
                $value = $this->resolveValue($context->findDot('output.search_box', true), $context);
                $buffer .= ($value === null ? '' : $value);
                $buffer .= '
';
...
';
    ...
    private function section106b751726c18d9d0a2600f98b963484(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section230168602eb7e298ac221fa06d825999(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section589806545bc41bb140a3a502e186158f(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
