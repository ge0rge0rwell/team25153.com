...
class __Mustache_1aaba46d208629d23108428b93e18614 extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionDedcc6948efcbac03a3026d9401b673e($context, $indent, $value);
    ...
    private function section09f26f1d124c8a1831c0b18f8203f1ba(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section0aeeebab911fdf3aed4e4296aab8247e(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionE9e30f169a59fd5f6cef993e61b501a7(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('core_courseformat/local/content/divider')) {
                    $context->pushBlockContext([
                        'extraclasses' => [$this, 'block3af99b2d90b859d376606ea486417d9b'],
                        'content' => [$this, 'block0eeb80ca7ba8be91c7d170a93f134bca'],
                    ]);
    ...
    private function sectionDedcc6948efcbac03a3026d9401b673e(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE9e30f169a59fd5f6cef993e61b501a7($context, $indent, $value);
                $buffer .= $indent . '</div>
';
                $context->pop();
            }
    ...
    public function block0eeb80ca7ba8be91c7d170a93f134bca($context)
    {
        $indent = $buffer = '';
        $buffer .= '            <a href="';
