...
class __Mustache_abc2ca1f94bff563310ad57084d7c3e0 extends \Mustache\Template
{
...
';
        $value = $context->find('showemojipicker');
        $buffer .= $this->section8c0541d55e2b75cfcd9326e272fa5fbc($context, $indent, $value);
...
';
    ...
    private function section07a791af5c174fd3e3f291519e22aecc(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section2244054c2b8c2f0af84a759e802290d0(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section5df971d582457358a4ccf481abd0509f(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section35672aca6eed52b4e7f1f578f80a0ee6(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section8c0541d55e2b75cfcd9326e272fa5fbc(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAb824786c8682f6171ef8d2596f84a5d(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB8de6adc8a0c753970767678630ae6df(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
