...
class __Mustache_1cda745d1ba14253fff3405c2b453162 extends \Mustache\Template
{
...
';
        ...
        $buffer .= $indent . '</div>
';
        $blockFunction = $context->findInBlock('core_courseformat/local/content-js');
    ...
    private function section8827b1a17576f48cfc178a23d2836e73(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionFacbfac0606048ebfae74ceeb14690de(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section986e0d757a08f2dc36e0f3ce06fcab6e(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section599ca8e4d6a882f4d9098f88d2f629d6(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionAa684381f58ae44f806f4400587dc145(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section5274b515c81740c56f6244e619ac02c6(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionE6922901afa7b60d3ce7403587f8d6c3(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section1da160641860c8b20cedef117a1d8cab(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
