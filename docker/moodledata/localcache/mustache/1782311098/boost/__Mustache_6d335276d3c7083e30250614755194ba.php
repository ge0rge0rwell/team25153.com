...
class __Mustache_6d335276d3c7083e30250614755194ba extends \Mustache\Template
{
...
';
        ...
        $value = $context->find('header');
        $buffer .= $this->section0455c618fd38eca5026b772ed1f2d620($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
        ...
        $buffer .= $this->sectionA6287251cc90370a52f0643d036fe218($context, $indent, $value);
...
';
    ...
    private function sectionBccf7206c7876c661ceebc6684a3fbca(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section0b7a74ef365e2e19e174c81d3ebda570(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA491b4f32b91c98101a61d30ef3ed910(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE1c5833858b6a763436e852c524f170c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section5c42c2ba118f2e9924725a2f71fafad6(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section519e85228001c7c16a286170a7bff714(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA05a9efa8a6615cafc2b7d6f99aac760(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section70fc2265f21857283760f122a5c52abf(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section9ea6be45f1588d6476c3f4a2d3f1e926(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section8115b5e8e6b9abaabc1687cbdb72c01c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionAf8896fa8c5fdd0e1cfb78b8faa4f817(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section0455c618fd38eca5026b772ed1f2d620(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
        ...
        if (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionAf8896fa8c5fdd0e1cfb78b8faa4f817($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function section1dee8adaf405bfc6db6cbb048fef1653(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section576d6685d716ecde6b92ddc9a8289706(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section5ce3d3c86107b7d34d71a49bbc8dff3b(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA6287251cc90370a52f0643d036fe218(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA2f2b2af0b16c00d6e2e61974694930a(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA63a7439b8574206817a198214053c63(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionCdf95f40518fe737f0c4916be6259f5c(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
