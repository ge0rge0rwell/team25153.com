...
class __Mustache_602f98727096f4292e213adb5d9c883d extends \Mustache\Template
{
...
';
        ...
        $buffer .= $this->section8d9eeb11aaf1bbf86eabb1661624ba44($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '            </span>
';
...
';
        $buffer .= $indent . '            <li>
';
        $buffer .= $indent . '                <a class="dropdown-item" href="#" data-filter="sort" data-pref="startdate" data-value="startdate" aria-controls="courses-view-';
        $value = $this->resolveValue($context->find('uniqid'), $context);
        $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
        $buffer .= '" role="menuitem" ';
        $value = $context->find('startdate');
...
';
        $buffer .= $indent . '                    ';
        $value = $context->find('str');
        $buffer .= $this->sectionA77e1dc03120aed84df30cec117acde8($context, $indent, $value);
        $buffer .= '
';
        $buffer .= $indent . '                </a>
';
...
';
    ...
    private function section3a112d2e610d065e3998597fb898d52d(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section7016c651e834f0a5f48c756ec74b3d9b(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section00871e7cf012c0b9c5739bfed1c5eac9(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionB0ea4a7ebfc5b03867821f8fff1464f2(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section9b648f1f09f3188ea683f5067867407a(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section037648795d7d9323f9a9ca07afaa53a8(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section58e09abc703d3d0cbecf6cb13bc20821(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionA77e1dc03120aed84df30cec117acde8(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (is_object($value) && is_callable($value)) {
            $source = ' sortbystartdate, block_myoverview ';
            $value = call_user_func($value, $source, $this->lambdaHelper);
        ...
        if (!empty($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ' sortbystartdate, block_myoverview ';
                $context->pop();
            }
        }
    ...
    private function section8d9eeb11aaf1bbf86eabb1661624ba44(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (is_object($value) && is_callable($value)) {
            $source = '{{#str}} sortbystartdate, block_myoverview {{/str}}';
            $value = call_user_func($value, $source, $this->lambdaHelper);
    ...
    private function section08bb7228c2ffecb240f755096910b2b6(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
