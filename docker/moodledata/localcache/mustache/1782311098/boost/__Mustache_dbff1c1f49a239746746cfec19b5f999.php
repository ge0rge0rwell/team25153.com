...
class __Mustache_dbff1c1f49a239746746cfec19b5f999 extends \Mustache\Template
{
    ...
    public function renderInternal(\Mustache\Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/drawer')) {
            $context->pushBlockContext([
                'tabindex' => [$this, 'block97cf4045effc9fee7c3d0e13d014f0be'],
                'role' => [$this, 'block8b2b56271b329fcb299a560c67215c3a'],
                'drawerattributes' => [$this, 'blockAe43c248733653bd709fcefd3a7cdc9f'],
                'drawercontent' => [$this, 'block17d5d89f3cc3dcb36b78ec12064af620'],
            ]);
...
';
    ...
    private function section076c21825773917156c592664c3a3803(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section256776dc607cdebe9d890b0efd29b5ba(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section6d28bf20960d3aa02f6d0d5da92b08c3(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function sectionF0c2ff2c291ba52af317c1ae28af0c22(\Mustache\Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block17d5d89f3cc3dcb36b78ec12064af620($context)
    {
        $indent = $buffer = '';
